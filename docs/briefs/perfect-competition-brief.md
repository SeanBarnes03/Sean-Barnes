...
hypothesis: "About 5 tomato, 20 carrot and 20 mesclun beds — tomato labor is 10% per bed versus 2.5% and 1.25%, and I expect that to counter a 3-4x revenue advantage within a few beds"
---
...
**By whom:** The farmer.  In theory perfect competition every actor is a price-taker.  She can't control the demand or the price, the only factor she can control is the supply of what she grows. 
...
Tomatoes earn the most, but become more expensive to plant, so I went with more mesclun and carrot for that reason, and both are cheaper to produce. Laying five tomato beds means each one takes about 60% more labor than a single bed. That's it.
